...
class CMsgSource2VProfLiteReportItem(BaseModel):
    ...
    active_samples_1secmax: int = Field(default=0)
    ...
    usec_1secmax_avg_active: int = Field(default=0)
    usec_1secmax_p50_active: int = Field(default=0)
    usec_1secmax_p95_active: int = Field(default=0)
    usec_1secmax_p99_active: int = Field(default=0)
    usec_1secmax_avg_all: int = Field(default=0)
    usec_1secmax_p50_all: int = Field(default=0)
    usec_1secmax_p95_all: int = Field(default=0)
    usec_1secmax_p99_all: int = Field(default=0)
...
class CMsgSource2NetworkFlowQuality(BaseModel):
    duration: int = Field(default=0)
    bytes_total: int = Field(default=0)
    bytes_total_reliable: int = Field(default=0)
    bytes_total_voice: int = Field(default=0)
    bytes_sec_p95: int = Field(default=0)
    bytes_sec_p99: int = Field(default=0)
    enginemsgs_total: int = Field(default=0)
    enginemsgs_sec_p95: int = Field(default=0)
    enginemsgs_sec_p99: int = Field(default=0)
    ticks_total: int = Field(default=0)
    ticks_good: int = Field(default=0)
    ticks_good_almost_late: int = Field(default=0)
    ticks_fixed_dropped: int = Field(default=0)
    ticks_fixed_late: int = Field(default=0)
    ticks_bad_dropped: int = Field(default=0)
    ticks_bad_late: int = Field(default=0)
    ticks_bad_other: int = Field(default=0)
    tick_missrate_samples_total: int = Field(default=0)
    tick_missrate_samples_perfect: int = Field(default=0)
    tick_missrate_samples_perfectnet: int = Field(default=0)
    tick_missratenet_p75_x10: int = Field(default=0)
    tick_missratenet_p95_x10: int = Field(default=0)
    tick_missratenet_p99_x10: int = Field(default=0)
    recvmargin_p1: int = Field(default=0)
    recvmargin_p5: int = Field(default=0)
    recvmargin_p25: int = Field(default=0)
    recvmargin_p50: int = Field(default=0)
    recvmargin_p75: int = Field(default=0)
    recvmargin_p95: int = Field(default=0)
