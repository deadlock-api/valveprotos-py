...
class CCitadelUserCmdPB(_message.Message):
    __slots__ = ["ang_camera_angles", "base", "camera_roaming_speed", "enemy_hero_aimed_at", "execute_ability_indices", "in_shop", "using_free_cursor", "vec_camera_position", "view_delta_x", "view_delta_y"]
    ...
    VIEW_DELTA_X_FIELD_NUMBER: _ClassVar[int]
    VIEW_DELTA_Y_FIELD_NUMBER: _ClassVar[int]
    ...
    view_delta_x: _containers.RepeatedScalarFieldContainer[int]
    view_delta_y: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, base: _Optional[_Union[_usercmd_pb2.CBaseUserCmdPB, _Mapping]] = ..., vec_camera_position: _Optional[_Union[_networkbasetypes_pb2.CMsgVector, _Mapping]] = ..., ang_camera_angles: _Optional[_Union[_networkbasetypes_pb2.CMsgQAngle, _Mapping]] = ..., execute_ability_indices: _Optional[int] = ..., in_shop: bool = ..., camera_roaming_speed: _Optional[float] = ..., using_free_cursor: bool = ..., enemy_hero_aimed_at: _Optional[int] = ..., view_delta_x: _Optional[_Iterable[int]] = ..., view_delta_y: _Optional[_Iterable[int]] = ...) -> None: ...
